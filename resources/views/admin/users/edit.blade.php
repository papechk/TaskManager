...
<!-- Page Header -->
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Modifier Utilisateur</h2>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Modifier les informations de <strong>{{ $user->name }}</strong></p>
</div>
        ...
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <label class="flex cursor-pointer items-center gap-2 rounded-lg border p-3 hover:bg-gray-50 dark:hover:bg-boxdark-2 {{ $user->roles->contains($role) ? 'border-primary-500 bg-primary-50 dark:bg-primary-500/10' : 'border-stroke dark:border-strokedark' }}">
            ...
            <!-- User Info Card -->
            <div class="mb-6 rounded-lg border border-stroke bg-gray-50 p-4 dark:border-strokedark dark:bg-boxdark-2">
                <div class="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900 dark:text-white">{{ $user->updated_at->format('d/m/Y') }}</p>
                    </div>
                </div>
            </div>
