...
@section('content')
    <div class="d-flex align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Nouvelle tâche</h1>
            <div class="text-muted small">Créez et assignez une nouvelle tâche.</div>
        </div>
        <div class="ml-auto">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-plus-circle mr-2"></i>Informations de la tâche</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('tasks.store') }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="testart_date" id="testart_date"
                                   ...
                                   value="{{ old('testart_date') }}" required>
                            @error('testart_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" name="testart_time" id="testart_time"
                                   ...
                                   value="{{ old('testart_time') }}" required>
                            @error('testart_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="tedescription" id="tedescription" rows="4"
                                      ...
                                      placeholder="Décrivez la tâche en détail..." required>{{ old('tedescription') }}</textarea>
                            @error('tedescription')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="tepriority" id="tepriority"
                                ...
                                <option value="faible" {{ old('tepriority') == 'faible' ? 'selected' : '' }}>Basse</option>
                            </select>
                            @error('tepriority')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fa fa-check mr-1"></i>Créer la tâche
                    </button>
                </div>
            </form>
        </div>
